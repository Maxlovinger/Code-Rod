  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (result.userType !== 'advisor') {
          setError('This login is for advisors only. Please use Student Login.')
          setLoading(false)
          return
        }
      ...
      <div className="relative z-10 w-full max-w-md mx-auto px-6">
        ...
        <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-lg shadow-lg shadow-red-500/10 p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">Advisor Login</h1>
            <p className="text-white/70">Sign in to your advisor account</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="advisor.email@haverford.edu"
                />
              </div>
            </div>
